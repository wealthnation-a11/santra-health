        ...
        <div className="flex-1 overflow-y-auto scrollbar-thin">
          {!activeConversation || activeConversation.messages.length === 0 ? (
            ...
            <div className="h-full flex flex-col items-center justify-center p-4 sm:p-8 text-center">
              <div className="w-16 h-16 sm:w-20 sm:h-20 santra-gradient rounded-3xl flex items-center justify-center mb-4 sm:mb-6 shadow-santra animate-float">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 max-w-lg w-full">
                {[
                  ...
                  <button
                    ...
                    className="text-left p-3 sm:p-4 bg-accent hover:bg-accent/80 rounded-xl text-sm text-foreground transition-colors border border-border hover:border-primary/30"
                  >
                    {suggestion}
                  </button>
                ))}
            ...
            /* Messages */
            <div className="max-w-3xl mx-auto px-3 sm:px-4 py-4 space-y-5 sm:space-y-6">
